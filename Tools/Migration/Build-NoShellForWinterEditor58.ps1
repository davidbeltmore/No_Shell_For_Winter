...
# EFCharacterCreationDazBridge has no C++ Daz symbols and remains enabled so its
# project-owned editor binary is regenerated by every cold build.  The Daz
# exclusion must never leak into the receipt used by the next editor launch.
& $buildBat NoShellForWinterEditor Win64 Development $projectPath `
    "-DisablePlugin=DazToUnreal"
